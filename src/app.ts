...
export const app = new Elysia()
    ...
    .onError(({ code, error, set }) => {
        ...
        if (parsedError instanceof ValidationError) {
            ...
            return errorResponse(parsedError.message, parsedError.statusCode, parsedError.details);
        }
        ...
        set.status = 500;
        return errorResponse("Internal Server Error", 500, parsedError.message || "Unknown Error");
    })
    .get("/", () => "Hello Elysia")
    .use(healthRoutes)
    .use(authRoutes)
